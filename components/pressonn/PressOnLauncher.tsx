...
// Aviso pequeño y dismissible (centro vertical, borde izquierdo) que lleva a la
// página /press-on. Aparece SOLO cuando la sección "Reserva express" (#reservar)
// está en pantalla, para no tapar el hero inicial.
